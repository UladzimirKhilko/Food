...
function cards() {
    ...
    (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getResurce)('http://localhost:3000/menu')
        .then(data => {
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2024-11-25');
